<template>
    <div id="goods">
      <div class="goodsItem" v-for="item in goodsList" @click="click(item)">
...
<style scoped>
  ...
  #goods .goodsItem .img1{
    width: 100%;
    height: auto;
    border-radius: 3px;

  }
  #goods .goodsItem div .span1{
    display: block;
    width: 100%;
    height: 20px;
    padding: 2px 2px;
  ...
  #goods .goodsItem div div{
    text-align: center;
  }
  #goods .goodsItem div div .span2{
    color: orangered;
  }
  #goods .goodsItem div .img2{
    width: 16px;
    height: 16px;
    vertical-align: -2px;
  }
  #goods .goodsItem div div .span3{
